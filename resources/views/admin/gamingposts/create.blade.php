    ...
    <form action="{{ route('admin.gamingposts.create') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="review-input">
            ...
            <div class="review-title">
                <input class="input-text" placeholder="レビュータイトル" type="text" name="mario_review[subject]" id="mario_review_subject">
            </div>
            <div class="review-txt-area">
                <div class="review-txt"><textarea class="text-area" placeholder="本文" name="movie_review[body]" id="movie_review_body" cols="40" rows="10"></textarea></div> 
            </div>
        </div>
    </form>
</div>
